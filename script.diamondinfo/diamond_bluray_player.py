...
def next_ep_play_movie(movie_year, movie_title, tmdb, menu):
	...
	kodi_send_command = 'kodi-send --action="RunScript(%s,info=diamond_rd_player,type=movie,movie_year=%s,movie_title=%s,tmdb=%s,test=True)"' % (addonID(), movie_year, movie_title, tmdb)
